...
export class KyselyPurchaseOrderRepository {
  ...
  async createPo(values: { poNumber: string; customerId?: string | null; vendorId?: string | null; brand?: string | null; notes?: string | null }) {
